...
const Rating = ({value,text})=>{
    return(
        <div className="rating">
            ...
            <span style={{color: 'yellow'}}>
                <i className={value>=4 ? 'fas fa-star': value >=3.5? 'fas fa-star-half-alt': 'fas-fa-star'}></i>
            </span>
            <span style={{color: 'yellow'}}>
                <i className={value>=5 ? 'fas fa-star': value >=4.5? 'fas fa-star-half-alt': 'fas-fa-star'}></i>
            </span>
            <span>
                {text}
            </span>
